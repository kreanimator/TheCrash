...
public class OBJ_Fridge3 extends Object {
    GamePanel gp;
    public final static String objName = "Fridge3";

    public OBJ_Fridge3(GamePanel gp,int col,int row) {
        super(gp,col,row);
        this.gp = gp;
        name = objName;
        speed = 0;
    ...
    public void getImage() {
        ...
        down1 = setup("tiles/exterior/fridge3", width, height);

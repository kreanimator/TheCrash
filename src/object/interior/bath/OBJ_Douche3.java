...
public class OBJ_Douche3 extends Object {

    GamePanel gp;
    public final static String objName = "Douche3";

    public OBJ_Douche3(GamePanel gp,int col,int row) {
        super(gp,col,row);
        this.gp = gp;
        name = objName;
        speed = 0;
    ...
    public void getImage() {
        ...
        down1 = setup("tiles/interior/bath/douche3", width, height);

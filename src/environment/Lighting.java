    ...
    public void setEntityLight(){
        ...
        for (int i =0; i < gp.obj[1].length;i++) {
            if (gp.obj[gp.currentMap][i] != null) {
                // Get the center x and y of the light circle
//                int centerX = gp.obj[gp.currentMap][i].getCenterX();
//
//                int centerY =gp.obj[gp.currentMap][i].getCenterY();
                int centerX = gp.obj[gp.currentMap][i].worldX * gp.tileSize/2;

                int centerY =gp.obj[gp.currentMap][i].worldY * gp.tileSize/2;
                ...
                // Create a gradation paint settings
                RadialGradientPaint gPaint = new RadialGradientPaint(centerX, centerY, gp.obj[gp.currentMap][i].lightRadius, fraction, color);

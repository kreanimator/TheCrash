...
public class OBJ_Douche1 extends Object {

    GamePanel gp;
    public final static String objName = "Douche1";

    public OBJ_Douche1(GamePanel gp,int col,int row) {
        super(gp,col,row);
        this.gp = gp;
        name = objName;
        speed = 0;
    ...
    public void getImage() {
        ...
        down1 = setup("tiles/interior/bath/douche1", width, height);
